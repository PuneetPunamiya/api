...
func handleHTTPServer(ctx context.Context, u *url.URL, resourceEndpoints *resource.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
